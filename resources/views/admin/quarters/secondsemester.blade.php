...
<head>
    ...
    <title>General Overview Second Semester</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/admin/export/generalsecondsemester" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['fourps'] as $data)
                                                <tr>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['slp'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['kalahi'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['spp'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['sfp'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['drrm'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['centenarrian'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('data6')['aics'] as $data)
                                                <tr>
                                                    <td>{{ $data->province_id }}</td>
