...
<head>
    ...
    <title>Davao Del Norte Second Quarter</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/admin/export/davaodelnorte/secondquarter" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['fourps'] as $data)
                                                <tr>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['slp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['kalahi'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['spp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['sfp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['drrm'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_two')['centenarrian'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                            ...
                            <div class="card shadow mb-4 mt-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach (session('ddn_two')['aics'] as $data)
                                            <tr>
                                                <td>{{ $data->municipality }}</td>
                                                <td>{{ $data->total_male_count }}</td>
                                                <td>{{ $data->total_female_count }}</td>
