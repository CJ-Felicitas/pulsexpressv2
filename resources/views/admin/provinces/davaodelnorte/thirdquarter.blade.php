...
<head>
    ...
    <title>Davao Del Norte Third Quarter</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/admin/export/davaodelnorte/thirdquarter" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['fourps'] as $data)
                                                <tr>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['slp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['kalahi'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['spp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['sfp'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['drrm'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach (session('ddn_three')['centenarrian'] as $data)
                                                <tr>
                                                    <td>{{ $data->municipality }}</td>
                                                    <td>{{ $data->total_male_count }}</td>
                                                    <td>{{ $data->total_female_count }}</td>
                            ...
                            <div class="card shadow mb-4 mt-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach (session('ddn_three')['aics'] as $data)
                                            <tr>
                                                <td>{{ $data->municipality }}</td>
                                                <td>{{ $data->total_male_count }}</td>
                                                <td>{{ $data->total_female_count }}</td>
